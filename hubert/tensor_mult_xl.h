...
void matrix_multiply(TensorXL &A, TensorXL &B, TensorXL &C) {
...
#pragma unroll
		for (int d = 0; d < DOT_VEC_SIZE; ++d) {
			running_sum += A_local_regs_stable[d] * TensorXL::get(B, s * DOT_VEC_SIZE + d, j);
		}
