...
# ----------------------------------------
# If mm_slave_add_avmm_0_rw is one of several IP cores in your
...
# ----------------------------------------
# ACDS 21.1 169 win32 2021.09.14.09:54:57
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "mm_slave_add_avmm_0_rw.mm_slave_add_avmm_0_rw"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/applications/intel_quartus/21.1/quartus/"
}
...
append ELAB_OPTIONS [subst [mm_slave_add_avmm_0_rw::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [mm_slave_add_avmm_0_rw::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [mm_slave_add_avmm_0_rw::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [mm_slave_add_avmm_0_rw::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [mm_slave_add_avmm_0_rw::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [mm_slave_add_avmm_0_rw::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
