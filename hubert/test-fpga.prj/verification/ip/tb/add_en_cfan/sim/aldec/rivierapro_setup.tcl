...
# ACDS 21.1 169 win32 2021.09.14.09:55:05
# ----------------------------------------
...
# ----------------------------------------
# If add_en_cfan is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "add_en_cfan.add_en_cfan"
}
...
append ELAB_OPTIONS [subst [add_en_cfan::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [add_en_cfan::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [add_en_cfan::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [add_en_cfan::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [add_en_cfan::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [add_en_cfan::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
