...
# ----------------------------------------
# If sso_add_B is one of several IP cores in your
...
# ----------------------------------------
# ACDS 21.1 169 win32 2021.09.14.09:55:02
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "sso_add_B.sso_add_B"
}
...
append ELAB_OPTIONS [subst [sso_add_B::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [sso_add_B::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [sso_add_B::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [sso_add_B::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [sso_add_B::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [sso_add_B::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
