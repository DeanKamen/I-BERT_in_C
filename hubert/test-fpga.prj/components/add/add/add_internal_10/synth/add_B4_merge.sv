...
// SystemVerilog created from add_B4_merge
...
module add_B4_merge (
    ...
    wire [0:0] i_i_0449_mux_s;
    reg [31:0] i_i_0449_mux_q;
    ...
    // out_forked46(GPOUT,11)
    assign out_forked46 = forked46_mux_q;

    // i_i_0449_mux(MUX,3)
    assign i_i_0449_mux_s = in_valid_in_0;
    always @(i_i_0449_mux_s or in_i_i_0449_1 or in_i_i_0449_0)
    begin
        unique case (i_i_0449_mux_s)
            1'b0 : i_i_0449_mux_q = in_i_i_0449_1;
            1'b1 : i_i_0449_mux_q = in_i_i_0449_0;
            default : i_i_0449_mux_q = 32'b0;
        endcase
    end

    // out_i_i_0449(GPOUT,12)
    assign out_i_i_0449 = i_i_0449_mux_q;
