...
// SystemVerilog created from add_B8_merge
...
module add_B8_merge (
    ...
    wire [0:0] inc35149_mux_s;
    reg [31:0] inc35149_mux_q;
    ...
    // out_forked95(GPOUT,11)
    assign out_forked95 = forked95_mux_q;

    // inc35149_mux(MUX,3)
    assign inc35149_mux_s = in_valid_in_0;
    always @(inc35149_mux_s or in_inc35149_1 or in_inc35149_0)
    begin
        unique case (inc35149_mux_s)
            1'b0 : inc35149_mux_q = in_inc35149_1;
            1'b1 : inc35149_mux_q = in_inc35149_0;
            default : inc35149_mux_q = 32'b0;
        endcase
    end

    // out_inc35149(GPOUT,12)
    assign out_inc35149 = inc35149_mux_q;
