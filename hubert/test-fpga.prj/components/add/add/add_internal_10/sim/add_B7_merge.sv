...
// SystemVerilog created from add_B7_merge
...
module add_B7_merge (
    ...
    wire [0:0] i_0443_mux_s;
    reg [31:0] i_0443_mux_q;
    ...
    // i_0443_mux(MUX,3)
    assign i_0443_mux_s = in_valid_in_0;
    always @(i_0443_mux_s or in_i_0443_1 or in_i_0443_0)
    begin
        unique case (i_0443_mux_s)
            1'b0 : i_0443_mux_q = in_i_0443_1;
            1'b1 : i_0443_mux_q = in_i_0443_0;
            default : i_0443_mux_q = 32'b0;
        endcase
    end

    // out_i_0443(GPOUT,12)
    assign out_i_0443 = i_0443_mux_q;
