...
// SystemVerilog created from add_i_iord_bl_call_unnamed_add1_add0
...
module add_i_iord_bl_call_unnamed_add1_add0 (
    ...
    // iord(EXTIFACE,7)
    assign iord_i_fifodata = in_iord_bl_call_add_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_add_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_add_i_fifodata),
    ...
    assign out_iord_bl_call_add_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,16)
    assign out_iord_bl_call_add_o_fifoalmost_full = iord_o_fifoalmost_full;
