...
int main()
{
    float r1[3] = {5.0533e14f, 1.1046e15f, 2.9980e15f};
    float *arg1[1] = {r1};
    Tensor<float>* arg1_t1 = new Tensor<float>(1,3,(float**)arg1);
    Tensor<float>::print(arg1_t1);

    Tensor<float>* arg2 = new Tensor<float>(1,1, 3.3355e-16f);

    scaled_tuple result1;
    QuantAct symmetric (16, 0.95f, true, false, -1, QuantMode::symmetric);
